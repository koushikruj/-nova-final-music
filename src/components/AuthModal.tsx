  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      try {
        ...
        if (popupErr?.code === 'auth/popup-blocked' || popupErr?.code === 'auth/unauthorized-domain') {
           // Fallback to redirect which works on mobile / restricted environments
           showToast("Popup blocked or restricted. Redirecting to Google...");
